...
const Footer = () => {
    return (
        <footer className="px-4 divide-y  bg-black text-white">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0 mt-10">
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        <span className="self-center text-2xl font-semibold">SportsGallery</span>
                    </a>
                </div>
            ...
            <div className="py-6 text-sm text-center dark:text-gray-400">© 2023 Sports Gallery. All rights reserved.</div>
        </footer>
    );
};
